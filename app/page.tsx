  ...
  const testimonials = [
    {
      ...
      role: "大学院生・工学研究科",
      content:
        "EZ-Termsのおかげで英語論文の読解速度が2倍になりました。専門用語の理解が格段に向上し、研究効率が大幅にアップしました。",
      avatar: "田中",
      rating: 5,
    },
    {
      ...
      role: "医学部・研究者",
      content:
        "学生にも推奨しています。医学用語の習得が効率的になり、論文執筆時の語彙選択も的確になりました。",
      avatar: "佐藤",
      rating: 5,
    },
    {
      ...
      role: "理学部・学部生",
      content:
        "英語が苦手でしたが、EZ-Termsで段階的に学習できるようになりました。TOEFLスコアも大幅に向上しました。",
      avatar: "山田",
      rating: 5,
    },
  ];
      ...
      <section className="pt-20 pb-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-scale-in mb-12">
            <Link
              href="/signup"
              className="gradient-primary text-white px-8 py-4 rounded-lg text-lg font-semibold hover:opacity-90 transition-opacity hover-lift gentle-glow"
            >
              無料で学習開始
            ...
            <Link
              href="/demo"
              className="bg-white text-green-600 px-8 py-4 rounded-lg text-lg font-semibold border-2 border-green-600 hover:bg-green-50 transition-colors hover-lift"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="elegant-card p-8 rounded-2xl hover-lift animate-fade-in"
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  <div
                    className={`w-12 h-12 bg-gradient-to-r ${feature.gradient} rounded-xl flex items-center justify-center mb-6 gentle-glow`}
                  >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 ${step.gradient} rounded-full flex items-center justify-center mx-auto mb-6 gentle-glow`}
                  >
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {ticketPlans.map((plan, index) => (
                <div
                  key={index}
                  className={`elegant-card p-8 rounded-2xl hover-lift relative ${
                    plan.popular ? "ring-2 ring-green-500 gentle-glow" : ""
                  }`}
                >
                  {plan.popular && (
          ...
          <div className="text-center">
            ...
            <div className="elegant-card p-8 rounded-2xl max-w-4xl mx-auto">
              <p className="text-gray-600 mb-6">
                ※現在準備中。今後は月額プランでチケット不要＆プレミアム機能もご利用いただけるようになります。
              </p>
              <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <Link
              href="/contact"
              className="bg-gray-100 text-gray-700 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-200 transition-colors hover-lift"
            >
              営業に問い合わせ
            </Link>
          </div>

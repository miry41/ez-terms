...
export default function AnalyticsPage() {
  ...
  const categoryData = [
    ...
    { category: 'テクノロジー', words: 289, mastery: 85, color: 'bg-purple-500' },
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-8">
            ...
            <div className="elegant-card p-6 gentle-hover">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{stats.masteredWords}</span>
              </div>
            ...
            <div className="elegant-card p-6 gentle-hover">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{stats.studyTime}時間</span>
              </div>
            ...
            <div className="elegant-card p-6 gentle-hover">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-2xl font-bold text-gray-900">{stats.weeklyGoal}%</span>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-8">
                  ...
                  <div key={day.day} className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-sm text-gray-700">{day.words}単語</span>
                        <span className="text-sm text-gray-500">{day.time}分</span>
                      </div>
            ...
            <div className="elegant-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-gray-900">カテゴリ別内訳</h3>
                  ...
                  <div key={category.category} className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-sm font-semibold text-gray-900">{category.words}単語</div>
                        <div className="text-xs text-gray-500">習得率{category.mastery}%</div>
                      </div>
                    </div>
                    <div className="bg-gray-200 rounded-full h-2">
                      <div 
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="elegant-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-gray-900">学習パターン</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-purple-50 rounded-lg">
                  <div>
                    <p className="font-medium text-gray-900">平均セッション</p>
            ...
            <div className="elegant-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-gray-900">最近の達成</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">スピード学習者</p>
                    <p className="text-sm text-gray-600">1セッション10語以上</p>
                  </div>
                </div>
            ...
            <div className="elegant-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold text-gray-900">おすすめ</h3>
                <Brain className="w-5 h-5 text-gray-400" />
              </div>
              <div className="space-y-4">
                <div className="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
                  <h4 className="font-medium text-gray-900 mb-2">科学用語に集中</h4>
                  <p className="text-sm text-gray-600 mb-3">科学分野の語彙に注意が必要です。毎日15分追加で学習しましょう。</p>
                  <button className="text-green-600 text-sm font-medium hover:text-green-700">
                    練習開始 →
                  </button>
                </div>
                <div className="p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-100">
                  <h4 className="font-medium text-gray-900 mb-2">朝の学習セッション</h4>
                  <p className="text-sm text-gray-600 mb-3">朝の学習効果が23%高いです。朝の時間帯にスケジュールしてみましょう。</p>
